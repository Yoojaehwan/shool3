...
<div id="detail">
		<div class="joinTop">
			<h2 class="text-center">${sessionScope_user.name} 수정정보</h2>
		</div>
				...
				<fieldset class="joinField">
					...
					<div class="form-group">
						<label for="input_pw" class="col-sm-4 control-label">비밀번호</label>
					 	<div class="col-sm-4">
							<input type="password" class="form-control" id="password" name="password" value="${sessionScope_user.password}"/>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="input_name" class="col-sm-4 control-label">주소</label>
					 	<div class="col-sm-4">
							<input type="text" class="form-control" id="addr" name="addr" value="${sessionScope_user.addr}"/>
						</div>
					</div>
					<div class="form-group">
